...
namespace Hidistro.Membership.Context
{
	...
	{
		private static readonly BizActorProvider bizActorProvider_0 = DataProviders.CreateInstance("Hidistro.Membership.Data.BizActorData,Hidistro.Membership.Data") as BizActorProvider;
		...
		{
			return BizActorProvider.bizActorProvider_0;
		}
