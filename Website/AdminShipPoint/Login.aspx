<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Hidistro.UI.Web.ShipPoint.Login" %>
...
body{ background:#F1F9FF url(../admin/images/loginbg.png) no-repeat center 0; }
.login{width:420px; height:227px; padding-top:194px; padding-left:224px; margin:0 auto; margin-top:80px;background:url(../admin/images/login_b.png) no-repeat;}
                    ...
                    if (temp != value) {
                        ...
                        $.ajax({
                            ...
                            success: function(resultData) {
                                ...
                                if (flag == "1") {
                                    $("#img_txtCode").attr("src", "../admin/images/true.gif");
                                }
                                else if (flag == "0") {
                                    $("#img_txtCode").attr("src", "../admin/images/false.gif");
                                }
                            }
                        });
                    }
