<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Shopadmin.AddMyCategory" CodeFile="AddMyCategory.aspx.cs" MasterPageFile="~/Shopadmin/Shopadmin.Master" %>
            ...
            <ul>
             ...
             <li> <span class="formitemtitle Pw_100">商品类型：</span>
              ...
              <ul class="btn Pa_100 clearfix">
                <asp:Button ID="btnSaveCategory" runat="server" OnClick="btnSaveCategory_Click" OnClientClick="return PageIsValid();" Text="确 定"  CssClass="submit_DAqueding float" />
                <asp:Button ID="btnSaveAddCategory" runat="server" OnClick="btnSaveAddCategory_Click" OnClientClick="return PageIsValid();" Text="保存并继续添加" CssClass="submit_jixu" />
         </ul>
          </div>
  </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function InitValidators()
        {
            ...
            initValid(new InputValidator('ctl00_contentHolder_txtRewriteName', 0, 60, true, '(^[-_a-zA-Z0-9]+$)', '使用URL重写长度限制在60个字符以内，必须为字母数字-和_'))
