<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Supplier_Admin_Products.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Supplier_Admin_Products" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
	...
	<div class="dataarea mainwidth databody">
	  <div class="title"> <em><img src="../../images/01.gif" width="32" height="32" /></em>
	    <h1 class="title_line">供应商已审核商品</h1>
	    <span class="font">已通过的商品可以进入平台出售，对商品更多操作，可以再平台商品总栏目中进行，商品名搜索条件可以输入供应商名进行查询</span>
     </div>
        ...
        <div class="columnright">
            <div class="formtab Pg_45" runat="server" id="htmlDivChecked">
                <ul>
                    ...
                    <li><a href="Supplier_Admin_ProductsErrorRefer.aspx">申请撤销（<asp:Literal runat="server" ID="litlErrorReferNum"></asp:Literal>）</a></li>
                </ul>
            </div>
		<!--搜索-->
			...
			<ul>
				...
				<li>
					<abbr class="formselect">
						<Hi:ProductCategoriesDropDownList ID="dropCategories" runat="server" NullToDisplay="--请选择店铺分类--" width="153"/>
					</abbr>
				</li>
				<li>
					<abbr class="formselect">
			...
			<div class="batchHandleArea">
				<ul>
					<li class="batchHandleButton">
                        ...
                        <span class="downproduct" ><a href="javascript:void(0)" onclick="CheckError()">撤销</a></span>
                        ...
                        <span class="printorder" ><a href="javascript:void(0)" onclick="EditMemberPrices()">调整会员零售价</a></span>    
                        <span class="printorder" ><a href="javascript:void(0)" onclick="EditDistributorPrices()">调整分销商采购价</a></span> 
                        <span class="printorder"><a href="javascript:void(0)" onclick="EditProdcutTag()">调整商品标签</a></span>  
                    <span class="printorder" style="display: ;"><a href="javascript:void(0)" onclick="RemarkOrder();">调整价格模板</a></span>
                    </li>
				</ul>
			</div>
		</div>		
	    ...
	    <UI:Grid runat="server" ID="grdProducts" Width="100%" AllowSorting="true" ShowOrderIcons="true" GridLines="None" DataKeyNames="ProductId"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="销售状态" ItemStyle-Width="80px" HeaderStyle-CssClass=" td_left td_right_fff">
                            <ItemTemplate>
                                <Hi:Supplier_DBLabel_PtSaleStatus runat="server"></Hi:Supplier_DBLabel_PtSaleStatus>
                            </ItemTemplate>
                        </asp:TemplateField>   
                        <asp:TemplateField HeaderText="操作" ItemStyle-Width="100px" HeaderStyle-CssClass=" td_left td_right_fff">
                            <ItemTemplate>
                                <span class="submit_bianji"><a onclick='<%# "showWindow_Page(" + Eval("ProductId") + ")" %>' style="cursor:pointer;" >查看</a></span>
...
<div style="display:none">
    ...
    <asp:Button ID="btnUpdateProductTags" runat="server" Text="商品标签" CssClass="submit_DAqueding" />
     ...
     <asp:Button ID="btnCheck" runat="server" Text="取消通过" CssClass="submit_DAqueding"/>
</div>
    <!--供应商价格模板--->
...
//                }
    ...
    function CheckError() {
        ...
        if (productIds.length > 0) {
            ...
            DialogShow("撤销", "window_checkerror", "Window_CheckError", "ctl00_contentHolder_btnCheck");
        }
    }
</script>
</asp:Content>