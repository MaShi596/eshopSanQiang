<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Supplier_Admin_ShipOrdersPriceTjForShipPoint.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Supplier_Admin_ShipOrdersPriceTjForShipPoint" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
	<div class="dataarea mainwidth databody">
     <div class="title">
          ...
          <h1><strong>发货点发货统计</strong></h1>
          <span>了解在某个时间范围内发货点发了多少货,已出售价为准</span>
		</div>
    ...
    <UI:Grid ID="grdManager" runat="server" AutoGenerateColumns="False"  ShowHeader="true" DataKeyNames="UserId" GridLines="None"
                   HeaderStyle-CssClass="table_title"  SortOrderBy="CreateDate" SortOrder="ASC" Width="100%">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="发货金额(按出售价)" HeaderStyle-CssClass="td_right td_left">
                            <ItemTemplate>
...
<script type="text/javascript">
    function showWindow_Page(auto) {
        ...
        DialogFrame("../admin/Cpage/Supplier/Supplier_Admin_ShipOrdersPriceTjForShipPointMingXi.aspx?userid=" + auto + "&t=" + currentDate.getTime(), "发货明细", null, null);
    }
</script>
</asp:Content>
