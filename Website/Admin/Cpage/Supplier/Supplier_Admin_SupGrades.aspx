<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Supplier_Admin_SupGrades.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Supplier_Admin_SupGrades" %>
...
<span>&nbsp;</span></div>
  ...
  <div class="datalist">
    <UI:Grid ID="grdMemberRankList" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="Auto" GridLines="None" Width="100%" HeaderStyle-CssClass="table_title">
              <Columns>
                  <asp:TemplateField HeaderText="等级名称" ItemStyle-Width="200px" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                           <%#Eval("Name") %>
                        </ItemTemplate>
                  </asp:TemplateField>
                  <asp:TemplateField HeaderText="操作" HeaderStyle-Width="100px" HeaderStyle-CssClass="td_right td_left">
                        ...
                        <ItemTemplate>
                             <span class="submit_bianji"><asp:HyperLink ID="lkbViewAttribute" runat="server" Text="编辑" NavigateUrl='<%# "Supplier_Admin_SupGradeEdit.aspx?GradeId="+Eval("auto")%>' ></asp:HyperLink></span>
                             <span class="submit_shanchu"><Hi:ImageLinkButton runat="server" ID="lkDelete" CommandName="Delete" IsShow="true" Text="删除" /></span>
                        </ItemTemplate>
                  </asp:TemplateField>
                  <asp:TemplateField HeaderText="供应商数量" ItemStyle-Width="100px" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                           <%# Eval("Num") %>
                        </ItemTemplate>
                  </asp:TemplateField>
