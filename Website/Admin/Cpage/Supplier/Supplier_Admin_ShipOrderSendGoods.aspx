<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Supplier_Admin_ShipOrderSendGoods.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Supplier_Admin_ShipOrderSendGoods"  %>
<%@ Register TagPrefix="Hi" Namespace="Hidistro.UI.Common.Controls" Assembly="Hidistro.UI.Common.Controls" %>
<%@ Register TagPrefix="Hi" Namespace="Hidistro.UI.ControlPanel.Utility" Assembly="Hidistro.UI.ControlPanel.Utility" %>
<%@ Register TagPrefix="UI" Namespace="ASPNET.WebControls" Assembly="ASPNET.WebControls" %>
<%@ Register TagPrefix="Hi" Namespace="Hidistro.UI.Common.Validator" Assembly="Hidistro.UI.Common.Validator" %>
<%@ Register TagPrefix="cc1" TagName="Order_ItemsList" Src="~/Admin/Cpage/Supplier/Ascx/Supplier_Order_ItemsList.ascx" %>
     ...
     <h1>物流信息</h1>
        ...
        <table width="200" border="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="10%" class="a_none"><span class="Name" style="display:none;"><a href="javascript:UpdateShippAddress('<%=Page.Request.QueryString["OrderId"] %>')">修改收货地址</a></span></td>
          </tr>
          <tr>
