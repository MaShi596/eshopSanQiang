<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Supplier_ShipPointEditPassword.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Supplier_ShipPointEditPassword" %>
...
<div class="areacolumn clearfix">
      ...
      <div class="columnright">
          ...
          <div class="formtab Pg_45">
                   <ul>
                      <li><a href='<%="Supplier_ShipPointEdit.aspx?userId="+Page.Request.QueryString["userId"] %>'>基本信息</a></li>
