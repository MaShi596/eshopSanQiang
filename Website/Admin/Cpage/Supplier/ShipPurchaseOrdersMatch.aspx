<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShipPurchaseOrdersMatch.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Cpage.Supplier.ShipPurchaseOrdersMatch" %>
...
<%@ Register TagPrefix="cc1" TagName="OrderMatch_ItemsList" Src="~/Admin/Cpage/Supplier/Supplier_Admin_PurchaseOrderMatch.ascx" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var orderid1 = Request["PurchaseOrderId"]
...
<body onload="AutoHeightMatch()">
    ...
    <div style="font-size: 12px; color: #404040;" class="">
        <table border="0" bordercolor="#E6E6E6" cellspacing="0px" style="border-collapse: collapse;width:100%;">
                    <tr>
            ...
            <asp:Literal runat="server" ID="txtShipPointNameAuto2"></asp:Literal>
