<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Supplier_Admin_PricetemplateAdd.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Supplier_Admin_PricetemplateAdd" %>
...
<div class="areacolumn clearfix">
      ...
      <div class="formitem validator4">
        <ul>
          <li> <span class="formitemtitle Pw_120">供应商价格模板名称：<em >*</em></span>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" Runat="Server">
        <script type="text/javascript" language="javascript">
            function InitValidators() {
                initValid(new InputValidator('ctl00_contentHolder_txtRankName', 1, 20, false, null, '供应商价格模板名称不能为空，长度限制在20个字符以内'));
