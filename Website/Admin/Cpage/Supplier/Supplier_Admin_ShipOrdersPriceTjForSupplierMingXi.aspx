<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Supplier_Admin_ShipOrdersPriceTjForSupplierMingXi.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Supplier_Admin_ShipOrdersPriceTjForSupplierMingXi" %>
...
<div class="dataarea mainwidth databody" style="padding:0px 10px 0px 10px;">
	  <div class="title"> <em><img src="../../images/01.gif" width="32" height="32" /></em>
	    <h1 class="title_line">供应商发货明细</h1>
	    <span class="font">供应商发货明细</span>
     </div>
  ...
  <div class="blank8 clearfix"></div>
      ...
      <table width="0" border="0" cellspacing="0">
		    <tr class="table_title">
              ...
              <td width="200" class="td_left td_right_fff">供应商</td>
		      <td width="200" class="td_left td_right_fff">发货单</td>
		      <td class="td_right td_left">供货价总额</td>
	        </tr>
	    </HeaderTemplate>
         <ItemTemplate>
	   		<tr>
		      ...
		      <td><Hi:FormatedMoneyLabel ID="lblOrderTotal" Money='<%#Eval("OrderCostPrice") %>' runat="server" /></td>
	        </tr>
     ...
     function showOrderItem(auto) {
         ...
         if (auto != undefined && auto != "") {
             ...
             if (display == "none") {
                 ...
                 var ptUrl = applicationPath + "/CPage/Supplier/ShipOrderItemsForSupplier.aspx?orderid=" + auto + "&t=" + currentDate1.getTime();
