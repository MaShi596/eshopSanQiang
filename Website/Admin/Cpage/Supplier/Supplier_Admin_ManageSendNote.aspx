<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Supplier_Admin_ManageSendNote.aspx.cs" Inherits="Hidistro.UI.Web.Admin.sales.Supplier_Admin_ManageSendNote" %>
        ...
        <div class="datalist">
            <div class="searcharea clearfix br_search">
                <ul>
                    ...
                    <li><span>订单类型：</span><abbr class="formselect">
                        <Hi:Supplier_Drop_OrderType runat="server" ID="drpOrderType"></Hi:Supplier_Drop_OrderType>
                    </abbr></li>
                    <li>
