<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Admin.Master" CodeBehind="Supplier_Admin_EditProduct.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Supplier_Admin_EditProduct" %>
	    ...
	    <div class="formitem validator1">
          ...
          <li><h2 class="colorE">基本信息</h2></li>
	       ...
	       <input type="hidden" value="0" id="hdlineId" runat="server" />
	        ...
	        <li id="salePriceRow">
            <span class="formitemtitle Pw_198">一口价：<em >*</em></span>
	        ...
	        <li id="costPriceRow"><span class="formitemtitle Pw_198">成本价：</span>
	            <Hi:TrimTextBox runat="server" CssClass="forminput" ID="txtCostPrice" />元<input id="btn_t" type="button" value="选择价格模板" onclick="RemarkOrder();"/>
                <%--<input id="Button1" type="button" value="选择" onclick="EditP_pricetemplate();"/>--%>
            ...
            <li class="clearfix"><span class="formitemtitle Pw_198">商品描述：</span>
                <Kindeditor:KindeditorControl ID="fckDescription" runat="server" Width="98%" Height="300"/>
...
<div style="display:none">
    ...
    <input type="hidden" id="hid_salPrice" runat="server" />
    <input type="hidden" id="hid_purchasePrice" runat="server" />
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    ...
    <script type="text/javascript" src="grade.price.helper.js"></script>
        ...
        <script type="text/javascript" src="../../../product/producttag.helper.js"></script>
...
<script type="text/javascript">
//    window.onload = EditP_pricetemplate();
</script>
</asp:Content>