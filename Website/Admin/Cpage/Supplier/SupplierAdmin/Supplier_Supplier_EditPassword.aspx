<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Supplier_Supplier_EditPassword.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Supplier_Supplier_EditPassword" %>
...
<div class="areacolumn clearfix">
		<div class="columnleft clearfix" style="display:none;">
                  <ul>
                        <li><a href="Supplier_SupManage.aspx"><span>供应商管理</span></a></li>
                  </ul>
</div>
      <div class="columnright">
          <div class="title title_height">
            <em><img src="../../../images/04.gif" width="32" height="32" /></em>
            <h1 class="title_line">修改登录密码</h1>
          </div>
          <div class="formtab Pg_45" style="display:none;">
                   <ul>
                      <li><a href='<%="Supplier_SupEdit.aspx?userId="+Page.Request.QueryString["userId"] %>'>基本信息</a></li>                                      
        ...
        <ul>
         <li>
		    ...
		    <li id="panelOld" runat="server">
			        ...
			        <span class="formitemtitle Pw_100">旧密码：<em >*</em></span>
			        <asp:TextBox ID="txtOldPassWord" runat="server" TextMode="Password" CssClass="forminput"></asp:TextBox>
			        
		    </li>
          <li> <span class="formitemtitle Pw_100">新密码：<em >*</em></span>
          ...
          <li> <span class="formitemtitle Pw_100">确认密码：<em >*</em></span>
