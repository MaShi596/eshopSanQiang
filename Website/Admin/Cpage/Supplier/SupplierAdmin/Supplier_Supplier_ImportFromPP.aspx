<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Supplier_Supplier_ImportFromPP.aspx.cs" Inherits="Hidistro.UI.Web.Admin.product.Supplier_Supplier_ImportFromPP" Title="无标题页" %>
...
<div class="optiongroup mainwidth">
		<ul>
			<li class="optionstar"><a href="Supplier_Supplier_ImportFromYfx.aspx"><span>从分销商城数据包导入</span></a></li>
			<li><a href="Supplier_Supplier_ImportFromTB.aspx" class="optionnext"><span>从淘宝数据包导入</span></a></li>
