<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Admin.Master" CodeBehind="Supplier_ProductEdit.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Supplier_ProductEdit" %>
          ...
          <li><h2 class="colorE">基本信息</h2></li>
	       ...
	       <input type="hidden" value="0" id="hdlineId" runat="server" />
	        ...
	        <li id="costPriceRow"><span class="formitemtitle Pw_198">供货价：<em >*</em></span>
	            ...
	            <p id="ctl00_contentHolder_txtCostPriceTip">商品的供货价</p>
	        </li>
            ...
            <style>
            .miaoshuright{ float:left; width:790px;}
            </style>
            <li class="clearfix" style=" padding-left:100px; overflow:hidden;"><span class="formitemtitle Pw_198" style=" float:left; text-align:left;">商品描述：</span>
                <Kindeditor:KindeditorControl ID="fckDescription" runat="server" Width="90%"   CssClass="miaoshuright"/>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript" language="javascript">
        function InitValidators() {
            ...
            initValid(new InputValidator('ctl00_contentHolder_txtCostPrice', 1, 10, false, '(0|(0+(\\.[0-9]{1,2}))|[1-9]\\d*(\\.\\d{1,2})?)', '必填，请输入有效金额'))
            ...
            initValid(new InputValidator('ctl00_contentHolder_txtWeight', 0, 10, true, '(0|(0+(\\.[0-9]{1,2}))|[1-9]\\d*(\\.\\d{1,2})?)', '数据类型错误，两位小数'))
