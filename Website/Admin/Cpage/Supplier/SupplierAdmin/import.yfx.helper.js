...
function getAttributes(typeId) {
    var postUrl = "Supplier_Supplier_ImportFromYfx.aspx?isCallback=true&action=getAttributes&timestamp=";
...
function getValues(attributeId) {
    var postUrl = "Supplier_Supplier_ImportFromYfx.aspx?isCallback=true&action=getValues&timestamp=";
