<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"  CodeBehind="Supplier_ProductAdd.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Supplier_ProductAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="headHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        var blLowestSalePrice = 0;
        var blSalePrice = 0;
        var blPurchasePrice = 0;
        var userid = <%= HiContext.Current.User.UserId %>

        $.ajax({
            url:  applicationPath +"/CPage/Supplier/Supplier_Handler.ashx",
            type: 'post', dataType: 'json', timeout: 10000,
            data: { action: "SupplierGet", userid: userid},
            cache: false,
            success: function (resultData) {
                
                if (resultData.Status == "1") {
                    blSalePrice = resultData.plSalePrice;
                    blLowestSalePrice = resultData.plLowestSalePrice;
                    blPurchasePrice = resultData.plPurchasePrice;                    
                }
            }
        });
        ...
        function CostPriceChange(obj)
        {
            ...
            var saleprice = (costPrice*blSalePrice/100);
            var lowestsaleprice =(costPrice*blLowestSalePrice/100);
            var purchaseprice = (costPrice*blPurchasePrice/100);

            $("#ctl00_contentHolder_txtSalePrice").val(saleprice);
            //$("#ctl00_contentHolder_txtSalePrice").focus();
            $("#ctl00_contentHolder_txtLowestSalePrice").val(lowestsaleprice);
            //$("#ctl00_contentHolder_txtLowestSalePrice").focus();
            $("#ctl00_contentHolder_txtPurchasePrice").val(purchaseprice);
            //$("#ctl00_contentHolder_txtPurchasePrice").focus();
            
            $('input[id*="salePrice_"]').val(saleprice);
            $('input[id*="purchasePrice_"]').val(purchaseprice);
            $('input[id*="costPrice_"]').val(costPrice);
        }
	  ...
	  <div class="datafrom">
	    <div class="formitem validator1">
          ...
          <li><h2 class="colorE">基本信息</h2></li>
            ...
            <li> <span class="formitemtitle Pw_198">所属产品线：<em >*</em></span>
	        ...
	        <li id="costPriceRow"><span class="formitemtitle Pw_198">供货价：<em >*</em></span>
	            <Hi:TrimTextBox runat="server" CssClass="forminput" ID="txtCostPrice" onChange="CostPriceChange(this)" />元
	            <p id="ctl00_contentHolder_txtCostPriceTip">必填,商品的供货价</p>
	        </li>
            ...
            <li id="skuRow"  style="display:none;">
                <p id="skuContent">
                    <input type="button" id="btnGenerateAll" value="生成所有规格" style="display:none;" />
	       ...
	       <li style="display:none;"><h2 class="colorE clear">相关设置</h2></li>
        ...
        <div style=" width:0px; height:0px; overflow:hidden;">
            <ul>
	            <li>
                    <span class="formitemtitle Pw_198">分销商最低零售价：<em >*</em></span>
	            ...
	            <li id="salePriceRow" ><span class="formitemtitle Pw_198">一口价：<em >*</em></span>
                  <Hi:TrimTextBox runat="server" CssClass="forminput" ID="txtSalePrice" />元<input type="button" onclick="editProductMemberPrice();" value="编辑会员价" style="display:none;" />
                ...
                <li id="purchasePriceRow" ><span class="formitemtitle Pw_198">分销商采购价：<em >*</em></span>
                    <Hi:TrimTextBox runat="server" CssClass="forminput" ID="txtPurchasePrice" />元<input type="button" onclick="editProductDistributorPrice();" value="编辑分销等级价" style="display:none;" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    ...
    <script type="text/javascript" language="javascript">       
       function InitValidators() {
           ...
           initValid(new InputValidator('ctl00_contentHolder_txtCostPrice', 1, 10, false, '(0|(0+(\\.[0-9]{1,2}))|[1-9]\\d*(\\.\\d{1,2})?)', '必填，请输入有效数字'));
           ...
           initValid(new InputValidator('ctl00_contentHolder_txtWeight', 0, 10, true, '-?[0-9]\\d*', '数据类型错误，只能输入整数型数值'));
