                ...
                <script type="text/javascript">
                    function showOrderMatchItem(auto, status) {
                        if (auto != undefined && auto != "" && status == "2") {
                            ...
                            var ptUrl = applicationPath + "/Admin/CPage/Supplier/ShipOrdersMatch.aspx?orderid=" + auto + "&t=" + currentDate1.getTime();
    ...
    <div class="dataarea mainwidth">
                    ...
                    <li class="batchHandleButton"><span class="signicon"></span><span class="allSelect">
                        ...
                        <span class="printorder"><a href="javascript:printPosts()">批量打印快递单</a></span> <span
                            class="printorder"><a href="javascript:printGoods()">批量打印发货单</a></span> <span class="downproduct">
                                <a href="javascript:downOrder()">下载配货单</a></span> <span class="sendproducts"><a href="javascript:batchSend()" onclick="">批量发货</a></span> </li>
                </ul>
            </div>
        </div>
        ...
        <div class="datalist">
            <asp:DataList ID="dlstOrders" runat="server" DataKeyField="OrderId" Width="100%">
                ...
                <ItemTemplate>
                    <tr class="td_bg">
                        <td style="background:#FF9900;color:#010101;">
                        ...
                        <td style="background:#FEC26A;color:#010101;">
                            提交时间：<Hi:FormatedTimeLabel ID="lblStartTimes" Time='<%#Eval("OrderDate") %>' ShopTime="true"
                                runat="server"></Hi:FormatedTimeLabel>
                        </td>
                        <td style="background:#FCD396;color:#010101;">
                            <%# (bool)Eval("IsPrinted")?"已打印":"未打印" %>
                        </td>
                        <td style="background:#FCD396;color:#010101;">&nbsp;</td>
                        <td style="background:#FCD396;color:#010101;">&nbsp;</td>
                        <td align="right" style="background:#FCD396;color:#010101;">&nbsp;
              ...
              <a style="color:Red" href="javascript:DialogFrame('<%# "Cpage/Supplier/Supplier_Admin_OrderOption.aspx?OrderId="+ Eval("OrderId") %>','生成发货单',null,null)">发货</a> </asp:Label>
                                ...
                                <Hi:ImageLinkButton ID="lkbtnOrderMatch" IsShow="true" runat="server" Text="默认匹配发货" CommandArgument='<%# Eval("OrderId") %>' CommandName="Match_Order"  DeleteMsg="确认要按默认匹配发货吗？" Visible="false" />
                            </span>
                        </td>
                    </tr>
            <tr style='<%#Eval("OrderStatus").ToString()=="2"?"": "display:none;" %>'>
            <td colspan="6">
             <iframe id='<%# "htmlIframeMatchPts_" + Eval("orderid") %>'  width="100%" scrolling="no" frameborder="0"  ></iframe>
                <%# "<script>showOrderMatchItem('" + Eval("orderid") + "','" + Eval("orderstatus") + "')</script>"%>
            </td>
            </tr>
            <tr style='<%#Eval("IsFenPei").ToString()=="False"?"display:none;":"" %>'>
            <td colspan="6">
