<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShipOrderItemsForShipPoint.aspx.cs" Inherits="Hidistro.UI.Web.ShipOrderItemsForShipPoint" %>
...
<body onload="AutoHeight()">
    ...
    <div style="font-size:12px;">
        ...
        <ItemTemplate>
             ...
             <td><Hi:FormatedMoneyLabel runat="server" Money='<%# Eval("ItemAdjustedPrice") %>'/></td>
             <td><%#Eval("weight") %></td>
