...
<div class="bMargin">
    <ul class="bPadding10">
        ...
        <li>
         ...
         <ul >
            <input type="button" name='<%# Eval("VoteId") %>' id="btnOK" value="提交/查看" onclick='voteOption(this.name , document.getElementById("<%# this.NamingContainer.ClientID + Convert.ToString(Eval("VoteId"))%>_Value").value);' />
        </ul>
 </div>
