...
<ItemTemplate>
 ...
 <li>
        ...
        <Hi:ListImage ID="HiImage1" runat="server" DataField="ThumbnailUrl160" /></Hi:ProductDetailsLink></div>
            <div class="name" style=" height:18px; overflow:hidden;"><Hi:ProductDetailsLink ID="ProductDetailsLink2" runat="server"  IsCountDownProduct="true"  ProductName='<%# Eval("ProductName") %>'  
