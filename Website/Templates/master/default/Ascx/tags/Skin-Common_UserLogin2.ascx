...
<asp:Panel runat="server" ID="pnlLogin">
	 <ul class="Default_Login_mar"> 用户名：<input id="txt_Common_Login_UserName" type="text" class="Default_Input"/></ul>
     <ul class="Default_Login_mar">密　码：<input name="Common_Login_Password" type="password" id="txt_Common_Login_Password"  class="Default_Input" /></ul>
     <ul class="Default_Login_pad5">
        <li class="Default_Login_bg">
            <a href="#" class="cWhite1" id="btn_Common_Login_Button" type="button"  >登录</a> 
            <a href="#" class="cWhite2" onclick='<%= "top.location.href=\"" + Globals.GetSiteUrls().UrlData.FormatUrl("register") + "\"" %>'>注册</a>
         </li>
     </ul>
</asp:Panel>
