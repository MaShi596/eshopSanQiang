        ...
        if (pastecontent != null && pastecontent != "" && pastecontent != "undefined") {
            switch (pastetype) {
                case "taobao":
                    ...
                    if (ship_info_arr[2]) ship_region_addr = ship_info_arr[2].split(' ');
                    if (ship_info_arr[3]) { $("#" + shippingaddress[3]).val(ship_info_arr[3]); $("#" + shippingaddress[3]).focus(); }
					if (ship_info_arr[4]) { $("#" + shippingaddress[4]).val(ship_info_arr[4]); }
