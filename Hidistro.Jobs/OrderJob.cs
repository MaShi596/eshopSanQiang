...
namespace Hidistro.Jobs
{
	public class OrderJob : IJob
	{
		public void Execute(XmlNode node)
		{
			...
			database.AddInParameter(sqlStringCommand, "PurchaseDate", System.Data.DbType.DateTime, DateTime.Now.AddDays((double)(-(double)masterSettings.ClosePurchaseOrderDays)));
			database.AddInParameter(sqlStringCommand, "ShippingDate", System.Data.DbType.DateTime, DateTime.Now.AddDays((double)(-(double)masterSettings.FinishOrderDays)));
			database.AddInParameter(sqlStringCommand, "PurchaseShippingDate", System.Data.DbType.DateTime, DateTime.Now.AddDays((double)(-(double)masterSettings.FinishPurchaseOrderDays)));
