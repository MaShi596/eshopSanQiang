...
{
	public class ProductSaleRanking : DistributorPage
	{
		...
		private void BindProductSaleRanking()
		{
			...
			int totalRecords = 0;
			System.Data.DataTable productSales = SubsiteSalesHelper.GetProductSales(saleStatisticsQuery, out totalRecords);
		...
		private void btnCreateReport_Click(object sender, System.EventArgs e)
		{
			...
			saleStatisticsQuery.SortOrder = SortAction.Desc;
			int num = 0;
			System.Data.DataTable productSalesNoPage = SubsiteSalesHelper.GetProductSalesNoPage(saleStatisticsQuery, out num);
