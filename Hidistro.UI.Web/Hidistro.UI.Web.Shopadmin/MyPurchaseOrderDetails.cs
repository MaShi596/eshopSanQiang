...
{
	public class MyPurchaseOrderDetails : DistributorPage
	{
		...
		protected System.Web.UI.WebControls.HyperLink hlkOrder;
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!base.IsPostBack)
			{
				...
				this.hlkOrder.Text = this.purchaseOrder.OrderId;
				this.hlkOrder.NavigateUrl = Globals.ApplicationPath + string.Format("/shopadmin/sales/MyOrderDetails.aspx?OrderId={0}", this.purchaseOrder.OrderId);
