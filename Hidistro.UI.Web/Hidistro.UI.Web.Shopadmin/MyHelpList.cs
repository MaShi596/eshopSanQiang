...
namespace Hidistro.UI.Web.Shopadmin
{
	public class MyHelpList : DistributorPage
	{
		...
		private void lkbtnDeleteCheck_Click(object sender, System.EventArgs e)
		{
			...
			if (num != 0)
			{
				int num2 = SubsiteCommentsHelper.DeleteHelps(list);
				this.BindSearch();
				this.dropHelpCategory.DataBind();
		...
		{
			DbQueryResult helpList = SubsiteCommentsHelper.GetHelpList(new HelpQuery
			{
				...
				SortBy = this.grdHelpList.SortOrderBy,
