...
{
	public class AddMyGroupBuy : DistributorPage
	{
		...
		private void btnAddGroupBuy_Click(object sender, System.EventArgs e)
		{
			...
			{
				if (SubsitePromoteHelper.ProductGroupBuyExist(this.dropGroupBuyProduct.SelectedValue.Value))
				{
			...
			if (SubsitePromoteHelper.AddGroupBuy(groupBuyInfo))
			{
