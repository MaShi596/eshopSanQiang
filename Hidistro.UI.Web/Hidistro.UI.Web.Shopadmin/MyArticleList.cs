	...
	public class MyArticleList : DistributorPage
	{
		...
		private void grdArticleList_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
		{
			...
			else
			{
				...
				{
					int rowIndex2 = ((System.Web.UI.WebControls.GridViewRow)((System.Web.UI.Control)e.CommandSource).NamingContainer).RowIndex;
					int articleId = (int)this.grdArticleList.DataKeys[rowIndex2].Value;
		...
		{
			DbQueryResult articleList = SubsiteCommentsHelper.GetArticleList(new ArticleQuery
			{
