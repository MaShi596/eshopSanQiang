...
namespace Hidistro.UI.Web.Shopadmin
{
	public class EditMyCountDown : DistributorPage
	{
		...
		private void btnUpdateGroupBuy_Click(object sender, System.EventArgs e)
		{
			...
			{
				CountDownInfo countDownInfo2 = SubsitePromoteHelper.GetCountDownInfo(this.countDownId);
				if (countDownInfo2.ProductId != this.dropGroupBuyProduct.SelectedValue.Value && SubsitePromoteHelper.ProductCountDownExist(this.dropGroupBuyProduct.SelectedValue.Value))
				{
