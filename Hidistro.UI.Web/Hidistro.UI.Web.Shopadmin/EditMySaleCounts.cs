...
{
	public class EditMySaleCounts : DistributorPage
	{
		...
		private void btnAddOK_Click(object sender, System.EventArgs e)
		{
			...
			{
				if (SubSiteProducthelper.UpdateShowSaleCounts(this.productIds, num))
				{
		...
		private void BindProduct()
		{
			...
			{
				this.grdSelectedProducts.DataSource = SubSiteProducthelper.GetProductBaseInfo(value);
