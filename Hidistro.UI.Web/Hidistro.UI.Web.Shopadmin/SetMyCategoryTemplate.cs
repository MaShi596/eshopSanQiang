...
namespace Hidistro.UI.Web.Shopadmin
{
	public class SetMyCategoryTemplate : DistributorPage
	{
		...
		private void btnUpload_Click(object sender, System.EventArgs e)
		{
			...
			string virtualPath = Globals.ApplicationPath + string.Format("/Templates/sites/{0}/{1}/categorythemes/", Hidistro.Membership.Context.HiContext.Current.User.UserId, siteSettings.Theme) + SetMyCategoryTemplate.GetFilename(System.IO.Path.GetFileName(this.fileThame.PostedFile.FileName), System.IO.Path.GetExtension(this.fileThame.PostedFile.FileName));
		...
		private void btnDelete_Click(object sender, System.EventArgs e)
		{
			...
			Hidistro.Membership.Context.SiteSettings siteSettings = Hidistro.Membership.Context.SettingsManager.GetSiteSettings(Hidistro.Membership.Context.HiContext.Current.User.UserId);
			string text = Globals.ApplicationPath + string.Format("/Templates/sites/{0}/{1}/categorythemes/", Hidistro.Membership.Context.HiContext.Current.User.UserId, siteSettings.Theme) + this.dropThmes.SelectedValue;
