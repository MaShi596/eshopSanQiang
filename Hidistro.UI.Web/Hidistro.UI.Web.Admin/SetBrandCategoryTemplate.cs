...
namespace Hidistro.UI.Web.Admin
{
	public class SetBrandCategoryTemplate : AdminPage
	{
		...
		private void btnUpload_Click(object sender, System.EventArgs e)
		{
			...
			string virtualPath = Hidistro.Membership.Context.HiContext.Current.GetSkinPath() + "/brandcategorythemes/" + SetBrandCategoryTemplate.GetFilename(System.IO.Path.GetFileName(this.fileThame.PostedFile.FileName), System.IO.Path.GetExtension(this.fileThame.PostedFile.FileName));
		...
		private void btnDelete_Click(object sender, System.EventArgs e)
		{
			...
			string text = Hidistro.Membership.Context.HiContext.Current.GetSkinPath() + "/brandcategorythemes/" + this.dropThmes.SelectedValue;
