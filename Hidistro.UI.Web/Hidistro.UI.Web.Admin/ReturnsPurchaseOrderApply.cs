...
namespace Hidistro.UI.Web.Admin
{
	...
	public class ReturnsPurchaseOrderApply : AdminPage
	{
		...
		private void lkbtnDeleteCheck_Click(object sender, System.EventArgs e)
		{
			...
			int num;
			if (SalesHelper.DelPurchaseReturnsApply(text.Split(new char[]
			{
				','
			}), out num))
			{
		...
		protected void btnAcceptReturns_Click(object sender, System.EventArgs e)
		{
			...
			SalesHelper.CheckPurchaseReturn(this.hidPurchaseOrderId.Value, Hidistro.Membership.Context.HiContext.Current.User.Username, num, this.hidAdminRemark.Value, int.Parse(this.hidRefundType.Value), true);
			this.BindReturns();
