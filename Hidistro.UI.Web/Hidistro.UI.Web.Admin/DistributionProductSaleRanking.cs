...
namespace Hidistro.UI.Web.Admin
{
	...
	public class DistributionProductSaleRanking : AdminPage
	{
		...
		private void BindProductSaleRanking()
		{
			...
			int totalRecords = 0;
			System.Data.DataTable distributionProductSales = DistributorHelper.GetDistributionProductSales(saleStatisticsQuery, out totalRecords);
