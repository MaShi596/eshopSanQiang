...
{
	public class Supplier_Admin_ProductsCheck : AdminPage
	{
		...
		protected System.Web.UI.WebControls.Button btnCheckError;
		protected TrimTextBox txtCheckPass;
		...
		private void btnCheck_Click(object sender, System.EventArgs e)
		{
			...
			Methods.Supplier_PtChecked(text);
			if (this.txtCheckPass.Text == "1")
			{
				ProductHelper.UpShelf(text);
			}
		...
		private void BindProducts()
		{
            ...
            DbQueryResult result = Methods.Supplier_PtSGet(entity, null, null, 1);
