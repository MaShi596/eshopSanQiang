...
namespace Hidistro.UI.Web.Admin
{
	...
	public class Main : AdminPage
	{
		...
		protected System.Web.UI.WebControls.HyperLink ltrWaitSendPurchaseOrdersNumber;
		...
		{
			Hidistro.Membership.Context.Users.GetUser(Hidistro.Membership.Context.HiContext.Current.User.UserId);
