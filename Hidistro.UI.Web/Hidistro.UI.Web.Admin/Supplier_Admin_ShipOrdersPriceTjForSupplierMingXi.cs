...
namespace Hidistro.UI.Web.Admin
{
	...
	public class Supplier_Admin_ShipOrdersPriceTjForSupplierMingXi : AdminPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (Hidistro.Membership.Context.HiContext.Current.User.IsInRole("供应商"))
			{
		...
		private void BindOrders()
		{
			...
			this.litlShipOrderPriceAll.Text = Methods.Supplier_ShipOrderCostPriceAllGet(orderQuery, this.userid).ToString("f2");
		}
