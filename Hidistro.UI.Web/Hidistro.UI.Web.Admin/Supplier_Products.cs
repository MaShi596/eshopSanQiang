...
{
	public class Supplier_Products : AdminPage
	{
		...
		protected System.Web.UI.WebControls.Literal litlChecked2;
		protected System.Web.UI.WebControls.Literal litlNoCheckNum2;
		...
		protected System.Web.UI.HtmlControls.HtmlGenericControl htmlSpanbtnError;
		protected ImageLinkButton btnError;
		protected System.Web.UI.HtmlControls.HtmlGenericControl htmlSpanbtnCheck;
		protected ImageLinkButton btnCheck;
		protected System.Web.UI.HtmlControls.HtmlGenericControl htmlSpanEditBaseInfo;
		protected System.Web.UI.HtmlControls.HtmlGenericControl htmlSpanEditMemberPrices;
		protected System.Web.UI.HtmlControls.HtmlGenericControl htmlSpanEditDistributorPrices;
		...
		private void btnError_Click(object sender, System.EventArgs e)
		{
			...
			Methods.Supplier_PtCheckErrorRefer(text, Hidistro.Membership.Context.HiContext.Current.User.UserId);
		...
		private void btnCheck_Click(object sender, System.EventArgs e)
		{
			...
			Methods.Supplier_PtCheck(text, Hidistro.Membership.Context.HiContext.Current.User.UserId);
			this.ShowMsg("操作成功", true);
			this.BindProducts();
		}
		...
		private void btnDelete_Click(object sender, System.EventArgs e)
		{
			...
			ProductHelper.DeleteProduct(text, true);
		...
		private void LoadParameters()
		{
			...
			{
				this.htmlSpanbtnDelete.Visible = false;
				this.htmlDivNoCheck.Visible = false;
				this.htmlSpanbtnCheck.Visible = false;
				this.htmlSpanEditMemberPrices.Visible = false;
				this.htmlSpanEditDistributorPrices.Visible = false;
				this.htmlSpanEditBaseInfo.Visible = false;
				return;
			}
			this.htmlSpanbtnError.Visible = false;
			this.htmlDivChecked.Visible = false;
		}
		...
		private void BindProducts()
		{
            ...
            DbQueryResult result = Methods.Supplier_PtSGet(entity, new int?(this.checkedStatus), new int?(HiContext.Current.User.UserId), null);
