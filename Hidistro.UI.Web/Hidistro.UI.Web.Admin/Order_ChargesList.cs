	...
	public class Order_ChargesList : System.Web.UI.UserControl
	{
		...
		public void LoadControls()
		{
			...
			if (this.order.Tax > 0m)
			{
				...
				System.Web.UI.WebControls.Literal expr_2C3 = this.litTax;
				expr_2C3.Text += "</span></td></tr>";
			}
			if (this.order.InvoiceTitle.Length > 0)
			{
				...
				System.Web.UI.WebControls.Literal expr_311 = this.litInvoiceTitle;
				expr_311.Text += "</span></td></tr>";
			}
		}
	}
}
