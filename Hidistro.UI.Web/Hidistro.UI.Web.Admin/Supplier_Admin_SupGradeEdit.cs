...
{
	public class Supplier_Admin_SupGradeEdit : AdminPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				System.Data.DataTable dataTable = Methods.Supplier_SupplierGradeGet(this.gradeId);
		...
		private void btnSubmitMemberRanks_Click(object sender, System.EventArgs e)
		{
			...
			Methods.Supplier_SupplierGradeUpdate(this.gradeId, text, num, num2, num3, remark);
