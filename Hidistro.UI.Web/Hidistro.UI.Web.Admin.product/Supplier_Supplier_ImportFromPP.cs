...
{
	public class Supplier_Supplier_ImportFromPP : AdminPage
	{
		...
		protected override void OnInitComplete(System.EventArgs e)
		{
			...
			this._dataPath = this.Page.Request.MapPath(string.Format("~/storage/Cpage/Supplier/{0}/paipai", Hidistro.Membership.Context.HiContext.Current.User.UserId));
