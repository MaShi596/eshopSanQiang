...
namespace Hidistro.UI.Web.Admin.product
{
	...
	public class ExportToYfx : AdminPage
	{
		...
		private void btnExport_Click(object sender, System.EventArgs e)
		{
			...
			{
				bool @checked = this.chkExportCostPrice.Checked;
				bool checked2 = this.chkExportStock.Checked;
				bool checked3 = this.chkExportImages.Checked;
				...
				System.Data.DataSet exportProducts = ProductHelper.GetExportProducts(this.GetQuery(), @checked, checked2, (string)this.ViewState["RemoveProductIds"]);
		...
		private void LoadParameters()
		{
			...
			int value2;
			if (!string.IsNullOrEmpty(this.Page.Request.QueryString["lineId"]) && int.TryParse(this.Page.Request.QueryString["lineId"], out value2))
			{
				this._lineId = new int?(value2);
				this.dropLines.SelectedValue = this._lineId;
			}
			this._startDate = this.calendarStartDate.SelectedDate;
			System.DateTime value3;
			if (!string.IsNullOrEmpty(this.Page.Request.QueryString["startDate"]) && System.DateTime.TryParse(this.Page.Request.QueryString["startDate"], out value3))
			{
				this._startDate = new System.DateTime?(value3);
                this.calendarStartDate.SelectedDate = this._startDate;
			}
			this._endDate = this.calendarEndDate.SelectedDate;
			System.DateTime value4;
			if (!string.IsNullOrEmpty(this.Page.Request.QueryString["endDate"]) && System.DateTime.TryParse(this.Page.Request.QueryString["endDate"], out value4))
			{
				this._endDate = new System.DateTime?(value4);
