...
namespace Hidistro.ControlPanel.Promotions
{
	...
	{
		private static readonly PromotionsProvider _defaultInstance;
		...
		{
			return PromotionsProvider._defaultInstance;
		}
		...
		public abstract System.Data.DataTable GetPromotions(bool isProductPromote, bool isWholesale);
