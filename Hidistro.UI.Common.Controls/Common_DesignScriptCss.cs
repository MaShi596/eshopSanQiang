...
namespace Hidistro.UI.Common.Controls
{
	public class Common_DesignScriptCss : Literal
	{
		...
		private string srcFormat = string.Concat(new string[]
		{
			...
			Globals.ApplicationPath,
			"/dialogtemplates/js/Hidistro_Dialog.js\" type=\"text/javascript\"></script><script src=\"",
			Globals.ApplicationPath,
			"/utility/jquery_hashtable.js\" type=\"text/javascript\"></script><script src=\"",
			Globals.ApplicationPath,
			"/dialogtemplates/js/Hidistro_Design.js\" type=\"text/javascript\"></script><link rel=\"stylesheet\" href=\"",
			Globals.ApplicationPath,
