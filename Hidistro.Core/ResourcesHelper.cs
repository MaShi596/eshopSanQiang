...
namespace Hidistro.Core
{
	public static class ResourcesHelper
	{
		...
		public static bool CheckPostedFile(HttpPostedFile postedFile)
		{
			...
			{
				string a = Path.GetExtension(postedFile.FileName).ToLower();
				if (a != ".jpg" && a != ".gif" && a != ".jpeg" && a != ".png" && a != ".bmp")
				{
					result = false;
				}
				else
				{
					string a2 = postedFile.ContentType.ToLower();
					result = (!(a2 != "image/pjpeg") || !(a2 != "image/jpeg") || !(a2 != "image/gif") || !(a2 != "image/bmp") || !(a2 != "image/png") || !(a2 != "image/x-png"));
				}
			}
			return result;
		}
