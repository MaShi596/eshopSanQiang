...
namespace Hidistro.Core
{
	public sealed class Serializer
	{
		...
		public static object ConvertToObject(string string_0, Type objectType)
		{
			object result = null;
		...
		public static void ConvertFromNameValueCollection(NameValueCollection nameValueCollection_0, ref string keys, ref string values)
		{
			if (nameValueCollection_0 != null && nameValueCollection_0.Count != 0)
			{
				...
				int num = 0;
				string[] allKeys = nameValueCollection_0.AllKeys;
				for (int i = 0; i < allKeys.Length; i++)
				{
					...
					string text2 = nameValueCollection_0[text];
