...
namespace Hidistro.Core.Configuration
{
	public class AppLocation
	{
		...
		internal void Add(HiApplication hiApplication_0)
		{
			if (this.hashtable_0.Contains(hiApplication_0.Name))
			{
				throw new Exception(string.Format(CultureInfo.InvariantCulture, "The HiApplication.Name ({0}) was not unique", new object[]
				{
					hiApplication_0.Name
				}));
			}
			this.hashtable_0.Add(hiApplication_0.Name, hiApplication_0);
			this.keys.Add(hiApplication_0.Name);
		}
