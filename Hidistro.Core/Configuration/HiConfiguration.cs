...
namespace Hidistro.Core.Configuration
{
	public class HiConfiguration
	{
		...
		private AppLocation appLocation_0;
		private SSLSettings sslsettings_0 = SSLSettings.Ignore;
		...
		public HiConfiguration(XmlDocument xmlDocument_0)
		{
			this.xmlDoc = xmlDocument_0;
		...
		internal void GetAttributes(XmlAttributeCollection attributeCollection)
		{
			...
			if (xmlAttribute != null)
			{
				this.sslsettings_0 = (SSLSettings)Enum.Parse(typeof(SSLSettings), xmlAttribute.Value, true);
			}
